...
const sessionConfig = {
    ...
    cookie: {
        httpOnly: true,
        expires: Date.now() + oneWeekInMiliseconds,
...
// serialization = "how do we store a user in a session"
// deserialization = "how do we unstore a user in a session"
...
app.all('*', (req, res, next)=>{
    next(new ExpressError('Page Not Found ¯\\_(ツ)_/¯', 404))
})
